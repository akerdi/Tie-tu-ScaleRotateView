...
-(UIImage *)cropToRect:(CGRect)rect{
    ...
    if (self.imageOrientation == UIImageOrientationRight) {
        rectt = CGRectMake(rect.origin.y, rect.origin.x, rect.size.height, rect.size.height);
    }else if (self.imageOrientation == UIImageOrientationLeft){
        rectt = CGRectMake(rect.size.width-rect.size.height-rect.origin.y, rect.origin.x, rect.size.height, rect.size.height);
    }else if (self.imageOrientation == UIImageOrientationUp){
        rectt = CGRectMake(rect.origin.x, rect.size.height-rect.size.width-rect.origin.y, rect.size.width, rect.size.width);
    }
    CGImageRef croppedImageRef = CGImageCreateWithImageInRect(self.CGImage, rectt);
    UIImage* cropped = [UIImage imageWithCGImage:croppedImageRef scale:self.scale orientation:self.imageOrientation];
